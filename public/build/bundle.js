...
var app = (function () {
    ...
    /* src/sideView/ui/Button.svelte generated by Svelte v3.42.6 */

    const file$1 = "src/sideView/ui/Button.svelte";
    ...
    /* src/sideView/App.svelte generated by Svelte v3.42.6 */

    const { console: console_1 } = globals;
    const file = "src/sideView/App.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	button = new Button({
    			props: { name: "Upload MicroPython" },
    			$$inline: true
    		});

    	button.$on("click", flashMicroPython);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, Button, flashMicroPython });
    	return [];
    }
